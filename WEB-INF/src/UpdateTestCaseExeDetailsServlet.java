...
public class UpdateTestCaseExeDetailsServlet extends HttpServlet
     {
	...
	out.println("<form action = \"./updateTestCaseExecution\" align=\"center\" method = POST>");
	...
	out.println("</html>");
                ...
                {             
                        out.println("<h4 align = center>Please enter Testcase id</h4>");
                }
                else
                {
          ...
          out.println("<form action = \"./updateTestCaseExecution\" method=POST>"); 
